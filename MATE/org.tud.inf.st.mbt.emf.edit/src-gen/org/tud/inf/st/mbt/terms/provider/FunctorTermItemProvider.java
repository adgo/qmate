...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.terms.FunctorTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctorTermItemProvider
	 ...
	 * @generated
	 */
	public FunctorTermItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctorTerm_functor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctorTerm_functor_feature", "_UI_FunctorTerm_type"),
				 TermsPackage.Literals.FUNCTOR_TERM__FUNCTOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TermsPackage.Literals.FUNCTOR_TERM__ARGUMENTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctorTerm"));
	}
	...
	public String getText(Object object) {
		String label = ((FunctorTerm)object).getFunctor();
		return label == null || label.length() == 0 ?
			getString("_UI_FunctorTerm_type") :
			getString("_UI_FunctorTerm_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctorTerm.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TermsPackage.Literals.FUNCTOR_TERM__ARGUMENTS,
