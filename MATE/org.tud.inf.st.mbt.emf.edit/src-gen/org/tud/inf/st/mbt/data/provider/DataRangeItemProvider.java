...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.data.DataRange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataRange_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataRange_values_feature", "_UI_DataRange_type"),
				 DataPackage.Literals.DATA_RANGE__VALUES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addEventIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataRange_eventID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataRange_eventID_feature", "_UI_DataRange_type"),
				 DataPackage.Literals.DATA_RANGE__EVENT_ID,
				 true,
				 false,
				 false,
	...
	protected void addLeafPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataRange_leaf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataRange_leaf_feature", "_UI_DataRange_type"),
				 DataPackage.Literals.DATA_RANGE__LEAF,
				 true,
				 false,
				 true,
				 null,
