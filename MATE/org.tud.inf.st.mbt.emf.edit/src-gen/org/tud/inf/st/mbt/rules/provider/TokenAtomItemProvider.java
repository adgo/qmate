...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.rules.TokenAtom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TokenAtomItemProvider
	 ...
	 * @generated
	 */
	public TokenAtomItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TokenAtom_count_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TokenAtom_count_feature", "_UI_TokenAtom_type"),
				 RulesPackage.Literals.TOKEN_ATOM__COUNT,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TokenAtom"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TokenAtom.class)) {
