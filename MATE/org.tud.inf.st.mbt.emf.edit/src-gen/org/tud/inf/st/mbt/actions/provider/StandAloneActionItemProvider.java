...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.actions.StandAloneAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StandAloneActionItemProvider
	 ...
	 * @generated
	 */
	public StandAloneActionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActionsPackage.Literals.STAND_ALONE_ACTION__ACTION);
			childrenFeatures.add(ActionsPackage.Literals.STAND_ALONE_ACTION__PARAMETERS);
		}
	...
	/**
	 * This returns StandAloneAction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StandAloneAction"));
	}
	...
	public String getText(Object object) {
		String label = ((StandAloneAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StandAloneAction_type") :
			getString("_UI_StandAloneAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StandAloneAction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActionsPackage.Literals.STAND_ALONE_ACTION__ACTION,
		...
		newChildDescriptors.add
			(createChildParameter
				(ActionsPackage.Literals.STAND_ALONE_ACTION__PARAMETERS,
