...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.ulang.guigraph.GuiGraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GuiGraphItemProvider
	 ...
	 * @generated
	 */
	public GuiGraphItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInvariantTextPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GuiGraph_invariant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GuiGraph_invariant_feature", "_UI_GuiGraph_type"),
				 GuigraphPackage.Literals.GUI_GRAPH__INVARIANT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Invariant Text feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInvariantTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GuiGraph_invariantText_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GuiGraph_invariantText_feature", "_UI_GuiGraph_type"),
				 GuigraphPackage.Literals.GUI_GRAPH__INVARIANT_TEXT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigraphPackage.Literals.GUI_GRAPH__ARCS);
			childrenFeatures.add(GuigraphPackage.Literals.GUI_GRAPH__NODES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GuiGraph"));
	}
	...
	public String getText(Object object) {
		String label = ((GuiGraph)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GuiGraph_type") :
			getString("_UI_GuiGraph_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GuiGraph.class)) {
