...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.features.FeatureReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureReferenceItemProvider
	extends IFeatureItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FeaturesPackage.Literals.FEATURE_REFERENCE__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureReference_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureReference_version_feature", "_UI_FeatureReference_type"),
				 FeaturesPackage.Literals.FEATURE_REFERENCE__VERSION,
				 true,
				 false,
				 true,
				 null,
