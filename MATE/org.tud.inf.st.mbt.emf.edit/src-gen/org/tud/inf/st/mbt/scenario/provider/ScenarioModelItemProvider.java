...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.scenario.ScenarioModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.SCENARIO_MODEL__INVENTORY);
			childrenFeatures.add(ScenarioPackage.Literals.SCENARIO_MODEL__BASES);
		}
	...
	public String getText(Object object) {
		String label = ((ScenarioModel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ScenarioModel_type") :
			getString("_UI_ScenarioModel_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO_MODEL__INVENTORY,
				 ScenarioFactory.eINSTANCE.createScenarioEntity()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO_MODEL__BASES,
