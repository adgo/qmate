...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.features.FeatureVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureVersionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureVersion"));
	}
	...
	public String getText(Object object) {
		String label = ((FeatureVersion)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureVersion_type") :
			getString("_UI_FeatureVersion_type") + " " + label;
	}
