...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.functions.StandAloneFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StandAloneFunctionItemProvider
	 ...
	 * @generated
	 */
	public StandAloneFunctionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.STAND_ALONE_FUNCTION__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((StandAloneFunction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StandAloneFunction_type") :
			getString("_UI_StandAloneFunction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StandAloneFunction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.STAND_ALONE_FUNCTION__PARAMETERS,
