...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.ulang.guigraph.Widget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WidgetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Widget_image_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Widget_image_feature", "_UI_Widget_type"),
				 GuigraphPackage.Literals.WIDGET__IMAGE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigraphPackage.Literals.WIDGET__CHILDREN);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Widget.class)) {
			case GuigraphPackage.WIDGET__IMAGE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GuigraphPackage.WIDGET__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuigraphPackage.Literals.WIDGET__CHILDREN,
