...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.rules.InstructionPointerAtom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstructionPointerAtomItemProvider
	 ...
	 * @generated
	 */
	public InstructionPointerAtomItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstructionPointerAtom_sequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstructionPointerAtom_sequence_feature", "_UI_InstructionPointerAtom_type"),
				 RulesPackage.Literals.INSTRUCTION_POINTER_ATOM__SEQUENCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addInstructionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstructionPointerAtom_instruction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstructionPointerAtom_instruction_feature", "_UI_InstructionPointerAtom_type"),
				 RulesPackage.Literals.INSTRUCTION_POINTER_ATOM__INSTRUCTION,
				 true,
				 false,
				 false,
	...
	protected void addStackLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstructionPointerAtom_stackLevel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstructionPointerAtom_stackLevel_feature", "_UI_InstructionPointerAtom_type"),
				 RulesPackage.Literals.INSTRUCTION_POINTER_ATOM__STACK_LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RulesPackage.Literals.INSTRUCTION_POINTER_ATOM__CONTEXT);
		}
	...
	/**
	 * This returns InstructionPointerAtom.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InstructionPointerAtom"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InstructionPointerAtom.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RulesPackage.Literals.INSTRUCTION_POINTER_ATOM__CONTEXT,
