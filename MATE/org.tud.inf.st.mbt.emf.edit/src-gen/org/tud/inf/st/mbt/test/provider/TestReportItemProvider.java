...
public class TestReportItemProvider
	 ...
	 * @generated
	 */
	public TestReportItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestPackage.Literals.TEST_REPORT__RUNS);
		}
	...
	public String getText(Object object) {
		String label = ((TestReport)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TestReport_type") :
			getString("_UI_TestReport_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.TEST_REPORT__RUNS,
