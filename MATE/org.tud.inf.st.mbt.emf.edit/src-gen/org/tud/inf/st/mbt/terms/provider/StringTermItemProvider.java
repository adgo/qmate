...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.mbt.terms.StringTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringTermItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringTerm_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringTerm_value_feature", "_UI_StringTerm_type"),
				 TermsPackage.Literals.STRING_TERM__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((StringTerm)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringTerm.class)) {
			case TermsPackage.STRING_TERM__VALUE:
