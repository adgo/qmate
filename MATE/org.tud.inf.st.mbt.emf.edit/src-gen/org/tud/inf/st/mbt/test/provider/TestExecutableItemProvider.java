 ...
 * @generated
 */
public class TestExecutableItemProvider
	 ...
	 * @generated
	 */
	public TestExecutableItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((TestExecutable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TestExecutable_type") :
			getString("_UI_TestExecutable_type") + " " + label;
	}
