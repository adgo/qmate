...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorePackage.ABSTRACT_MODEL_ELEMENT: {
			...
			case CorePackage.GENERIC_MODEL_CONTAINER: {
				GenericModelContainer genericModelContainer = (GenericModelContainer)theEObject;
				T result = caseGenericModelContainer(genericModelContainer);
				if (result == null) result = caseAbstractModelElement(genericModelContainer);
				if (result == null) result = caseITopLevelElement(genericModelContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.ITOP_LEVEL_ELEMENT: {
				ITopLevelElement iTopLevelElement = (ITopLevelElement)theEObject;
				T result = caseITopLevelElement(iTopLevelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.ICONTEXT_VARIABLE: {
				IContextVariable iContextVariable = (IContextVariable)theEObject;
				T result = caseIContextVariable(iContextVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generic Model Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generic Model Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGenericModelContainer(GenericModelContainer object) {
		return null;
	}
