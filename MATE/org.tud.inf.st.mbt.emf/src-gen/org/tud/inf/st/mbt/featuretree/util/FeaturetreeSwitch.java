 ...
 * @generated
 */
public class FeaturetreeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FeaturetreePackage.FEATURE_TREE: {
				FeatureTree featureTree = (FeatureTree)theEObject;
				T result = caseFeatureTree(featureTree);
				if (result == null) result = caseAbstractModelElement(featureTree);
				if (result == null) result = caseIFeatureDomain(featureTree);
				if (result == null) result = caseITopLevelElement(featureTree);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeaturetreePackage.TREE_FEATURE: {
				TreeFeature treeFeature = (TreeFeature)theEObject;
				T result = caseTreeFeature(treeFeature);
				if (result == null) result = caseFeature(treeFeature);
				if (result == null) result = caseAbstractModelElement(treeFeature);
				if (result == null) result = caseIFeature(treeFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tree Feature</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tree Feature</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTreeFeature(TreeFeature object) {
		return null;
	}
