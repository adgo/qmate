...
public class NewDataSpaceWizard extends BasicNewFileResourceWizard {

	@Override
	public void addPages() {
		super.addPages();
		((WizardNewFileCreationPage)getStartingPage()).setFileExtension("data");
	}
	...
	public boolean performFinish() {
		...
		r.getContents().add(DataFactory.eINSTANCE.createDataStructure());
		r.getContents().add(DataFactory.eINSTANCE.createDataClass());
