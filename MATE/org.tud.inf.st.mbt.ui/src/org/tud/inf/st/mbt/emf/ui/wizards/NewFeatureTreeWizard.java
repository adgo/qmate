...
public class NewFeatureTreeWizard extends BasicNewFileResourceWizard {

	@Override
	public void addPages() {
		super.addPages();
		((WizardNewFileCreationPage)getStartingPage()).setFileExtension("tree");
	}
	...
	public boolean performFinish() {
		...
		r.getContents().add(FeaturetreeFactory.eINSTANCE.createFeatureTree());
		try {
