/**
 */
package org.tud.inf.st.mbt.core.presentation;
...
import org.tud.inf.st.mbt.emf.editor.AllEditorPlugin;
...
public class CoreActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(AllEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
					...
					AllEditorPlugin.INSTANCE.log(exception);
				}
			}
		};
	...
	protected IAction refreshViewerAction =
		new Action(AllEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(AllEditorPlugin.INSTANCE.getString("_UI_CoreEditor_menu"), "org.tud.inf.st.mbt.coreMenuID");
		...
		//
		createChildMenuManager = new MenuManager(AllEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(AllEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(AllEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(AllEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
