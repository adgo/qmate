...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.pccs.MetaModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaModelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetaModel_modelURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaModel_modelURI_feature", "_UI_MetaModel_type"),
				 PccsPackage.Literals.META_MODEL__MODEL_URI,
				 true,
				 false,
				 false,
	...
	protected void addPrefixPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MetaModel_prefix_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaModel_prefix_feature", "_UI_MetaModel_type"),
				 PccsPackage.Literals.META_MODEL__PREFIX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((MetaModel)object).getModelURI();
