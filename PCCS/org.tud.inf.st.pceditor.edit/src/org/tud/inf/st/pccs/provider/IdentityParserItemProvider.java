...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.pccs.IdentityParser} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentityParserItemProvider
	 ...
	 * @generated
	 */
	public IdentityParserItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PccsPackage.Literals.IDENTITY_PARSER__PARSER);
		}
	...
	/**
	 * This returns IdentityParser.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IdentityParser"));
	}
	...
	public String getText(Object object) {
		String label = ((IdentityParser)object).getMultiplicity();
		return label == null || label.length() == 0 ?
			getString("_UI_IdentityParser_type") :
			getString("_UI_IdentityParser_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IdentityParser.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PccsPackage.Literals.IDENTITY_PARSER__PARSER,
