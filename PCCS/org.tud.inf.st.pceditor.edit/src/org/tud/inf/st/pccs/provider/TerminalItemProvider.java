...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.pccs.Terminal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminalItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PccsPackage.Literals.TERMINAL__TERMINAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Terminal)object).getTerminal();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Terminal.class)) {
			case PccsPackage.TERMINAL__TERMINAL:
