...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.pccs.SequenceParser} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceParserItemProvider
	 ...
	 * @generated
	 */
	public SequenceParserItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PccsPackage.Literals.SEQUENCE_PARSER__PARSERS);
		}
	...
	/**
	 * This returns SequenceParser.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SequenceParser"));
	}
	...
	public String getText(Object object) {
		String label = ((SequenceParser)object).getMultiplicity();
		return label == null || label.length() == 0 ?
			getString("_UI_SequenceParser_type") :
			getString("_UI_SequenceParser_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SequenceParser.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PccsPackage.Literals.SEQUENCE_PARSER__PARSERS,
