...
/**
 * This is the item provider adapter for a {@link org.tud.inf.st.pccs.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PccsPackage.Literals.ASSIGNMENT__TO,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PccsPackage.Literals.ASSIGNMENT__FROM);
		}
	...
	public String getText(Object object) {
		String label = ((Assignment)object).getTo();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Assignment.class)) {
			case PccsPackage.ASSIGNMENT__TO:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PccsPackage.ASSIGNMENT__FROM:
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PccsPackage.Literals.ASSIGNMENT__FROM,
